...
from surgeNN.models import train_mlr,predict_mlr,build_cnn
...
tg = 'delfzijl-delfzl-nld-rws.csv' #site to predict
predictand = load_predictand('/Users/timhermans/Documents/PostDoc/Phase3_statistical_surges/t_tide_6h_anoms_predictands/',tg) #open predictand csv
predictors = load_predictors('/Users/timhermans/Documents/PostDoc/Phase3_statistical_surges/era5_predictors/',tg) #open predictor xarray dataset
